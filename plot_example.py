...
import os
# Load data and model
PATH = '/Projects/COMMIT/amitbou/One_Shot_Path_Planning/database/generated_environments_chunk_95/'
model_path = 'trained_model/100*100_mini_batch_500K/model_2d.keras'
